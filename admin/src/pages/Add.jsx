   ...
   const onSubmitHandler= async (e)=>{
    ...
    try {
      const formData=new FormData()
        ...
        formData.append("description",descriptioon)
  ...
  return (
   <form onSubmit={onSubmitHandler} className=' flex flex-col w-full items-start gap-3'>
    ...
    <div className='w-full'>
      <p className='mb-2'> Produnt name</p>
       <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Type here' required />
    </div>

    <div className='w-full'>
      <p className='mb-2'>Product descriptioon </p>
       <textarea onChange={(e)=>setDescription(e.target.value)} value={descriptioon} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Write content here' required />
    </div>
    ...
    <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
      ...
      <div>
        <p className='mb-2 '>Product Price</p>
         <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='00' />
      </div>
       <div>
        <p className='mb-2 '>Discount</p>
         <input onChange={(e)=>setDiscount(e.target.value)} value={discount} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='00' />
      </div>
    ...
    <div>
     ...
     <div className='flex gap-2 mt-2'>
      ...
      <button type='submit' className='w-28 bg-black text-white py-3 mt-4 rounded-lg '>ADD</button>
